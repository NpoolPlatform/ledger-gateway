...
require (
	...
	github.com/NpoolPlatform/inspire-middleware v0.0.0-20240109073823-2cb1d3a3351a
	...
	github.com/NpoolPlatform/order-middleware v0.0.0-20240104060557-0e304eb3830b
