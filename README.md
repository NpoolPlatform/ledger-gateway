# Npool ledger gateway

[![Test](https://github.com/NpoolPlatform/ledger-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/ledger-gateway/actions/workflows/main.yml)
...
* make ledger-gateway ```单独编译服务```
* make ledger-gateway-image ```单独生成服务镜像```
